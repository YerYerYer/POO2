...
INSERT INTO USERS 
(ID_USUARIO, ID_EMPLEADO, NOMBRE_USUARIO, PASSWORD, ROL) 
VALUES
-- GERENCIA Y JEFATURAS (ADMINS)
(1, 1001, 'ARojas', SHA2('ARojas123', 256), 'ADMIN'),
(2, 1002, 'PAraya', SHA2('PAraya123', 256), 'ADMIN'),
(3, 1003, 'PNunez', SHA2('PNunez123', 256), 'ADMIN'),
(4, 1004, 'LCastillo', SHA2('LCastillo123', 256), 'ADMIN'),
(5, 1005, 'DMunoz', SHA2('DMunoz123', 256), 'ADMIN'),
(6, 1006, 'GPerez', SHA2('GPerez123', 256), 'ADMIN'),
(7, 1007, 'HGuzman', SHA2('HGuzman123', 256), 'ADMIN'),
(8, 1008, 'HVega', SHA2('HVega123', 256), 'ADMIN'),
(9, 1009, 'JSoto', SHA2('JSoto123', 256), 'ADMIN'),
(10, 1010, 'CSoto', SHA2('CSoto123', 256), 'ADMIN'),
(11, 1011, 'EFlores', SHA2('EFlores123', 256), 'ADMIN'),
(12, 1012, 'MZapata', SHA2('MZapata123', 256), 'ADMIN'),
(13, 1013, 'CTapia', SHA2('CTapia123', 256), 'ADMIN'),
(14, 1014, 'SBravo', SHA2('SBravo123', 256), 'ADMIN'),
(15, 1015, 'IGuzman', SHA2('IGuzman123', 256), 'ADMIN'),
(16, 1016, 'RMoral', SHA2('RMoral123', 256), 'ADMIN'),
(17, 1017, 'FRojas', SHA2('FRojas123', 256), 'ADMIN'),
(18, 1018, 'RMorales', SHA2('RMorales123', 256), 'ADMIN'),
(19, 1019, 'ESilva', SHA2('ESilva123', 256), 'ADMIN'),
(20, 1020, 'VDiaz', SHA2('VDiaz123', 256), 'ADMIN'),

-- PERSONAL OPERATIVO (EMPLEADOS REGULARES)
(21, 1021, 'JTorres', SHA2('JTorres123', 256), 'EMPLEADO'),
(22, 1022, 'MCastro', SHA2('MCastro123', 256), 'EMPLEADO'),
(23, 1023, 'PGomez', SHA2('PGomez123', 256), 'EMPLEADO'),
(24, 1024, 'SHerrera', SHA2('SHerrera123', 256), 'EMPLEADO'),
(25, 1025, 'DSalas', SHA2('DSalas123', 256), 'EMPLEADO'),
(26, 1026, 'CDiaz', SHA2('CDiaz123', 256), 'EMPLEADO'),
(27, 1027, 'VRobles', SHA2('VRobles123', 256), 'EMPLEADO'),
(28, 1028, 'CSotoOp', SHA2('CSotoOp123', 256), 'EMPLEADO'),
(29, 1029, 'AVera', SHA2('AVera123', 256), 'EMPLEADO'),
(30, 1030, 'GLeiva', SHA2('GLeiva123', 256), 'EMPLEADO'),
(31, 1031, 'FNunez', SHA2('FNunez123', 256), 'EMPLEADO'),
(32, 1032, 'CSotoC', SHA2('CSotoC123', 256), 'EMPLEADO'),
(33, 1033, 'BRuiz', SHA2('BRuiz123', 256), 'EMPLEADO'),
(34, 1034, 'FCastro', SHA2('FCastro123', 256), 'EMPLEADO'),
(35, 1035, 'GPena', SHA2('GPena123', 256), 'EMPLEADO'),
(36, 1036, 'JLopez', SHA2('JLopez123', 256), 'EMPLEADO'),
(37, 1037, 'RSoto', SHA2('RSoto123', 256), 'EMPLEADO'),
(38, 1038, 'CRojas', SHA2('CRojas123', 256), 'EMPLEADO'),
(39, 1039, 'MAguilera', SHA2('MAguilera123', 256), 'EMPLEADO'),
(40, 1040, 'SDiaz', SHA2('SDiaz123', 256), 'EMPLEADO'),
(41, 1041, 'CMoya', SHA2('CMoya123', 256), 'EMPLEADO'),
(42, 1042, 'PMiranda', SHA2('PMiranda123', 256), 'EMPLEADO'),
(43, 1043, 'JVargas', SHA2('JVargas123', 256), 'EMPLEADO'),
(44, 1044, 'ERojas', SHA2('ERojas123', 256), 'EMPLEADO'),
(45, 1045, 'MDiaz', SHA2('MDiaz123', 256), 'EMPLEADO'),
(46, 1046, 'DSoto', SHA2('DSoto123', 256), 'EMPLEADO'),
(47, 1047, 'CPerez', SHA2('CPerez123', 256), 'EMPLEADO'),
(48, 1048, 'NRamos', SHA2('NRamos123', 256), 'EMPLEADO'),
(49, 1049, 'RLeiva', SHA2('RLeiva123', 256), 'EMPLEADO'),

-- GERENTE DE INGENIERÍA (ADMIN)
(50, 1050, 'JLAGOS', SHA2('JLAGOS123', 256), 'ADMIN'),

-- MÁS EMPLEADOS REGULARES
(51, 1051, 'LVidela', SHA2('LVidela123', 256), 'EMPLEADO'),
(52, 1052, 'MJara', SHA2('MJara123', 256), 'EMPLEADO'),
(53, 1053, 'NSoto', SHA2('NSoto123', 256), 'EMPLEADO'),
(54, 1054, 'PMorales', SHA2('PMorales123', 256), 'EMPLEADO'),
(55, 1055, 'ARivas', SHA2('ARivas123', 256), 'EMPLEADO'),
(56, 1056, 'RDiaz', SHA2('RDiaz123', 256), 'EMPLEADO'),
(57, 1057, 'FVega', SHA2('FVega123', 256), 'EMPLEADO'),
(58, 1058, 'GJara', SHA2('GJara123', 256), 'EMPLEADO'),
(59, 1059, 'IFlores', SHA2('IFlores123', 256), 'EMPLEADO'),
(60, 1060, 'ELagos', SHA2('ELagos123', 256), 'EMPLEADO'),
(61, 1061, 'GFuenzal', SHA2('GFuenzal123', 256), 'EMPLEADO'),
(62, 1062, 'TSoto', SHA2('TSoto123', 256), 'EMPLEADO'),
(63, 1063, 'RPalma', SHA2('RPalma123', 256), 'EMPLEADO'),
(64, 1064, 'PNunezP', SHA2('PNunezP123', 256), 'EMPLEADO'),
(65, 1065, 'HHerrera', SHA2('HHerrera123', 256), 'EMPLEADO'),
(66, 1066, 'MGonzalez', SHA2('MGonzalez123', 256), 'EMPLEADO'),
(67, 1067, 'ERojasE', SHA2('ERojasE123', 256), 'EMPLEADO'),
(68, 1068, 'ADiaz', SHA2('ADiaz123', 256), 'EMPLEADO'),
(69, 1069, 'FMorales', SHA2('FMorales123', 256), 'EMPLEADO'),
(70, 1070, 'SBravoS', SHA2('SBravoS123', 256), 'EMPLEADO'),
(71, 1071, 'BFlores', SHA2('BFlores123', 256), 'EMPLEADO'),
(72, 1072, 'VMorales', SHA2('VMorales123', 256), 'EMPLEADO'),
(73, 1073, 'GLagos', SHA2('GLagos123', 256), 'EMPLEADO'),
(74, 1074, 'IPena', SHA2('IPena123', 256), 'EMPLEADO'),
(75, 1075, 'DRiquelme', SHA2('DRiquelme123', 256), 'EMPLEADO'),
(76, 1076, 'VVidal', SHA2('VVidal123', 256), 'EMPLEADO'),
(77, 1077, 'AGuzman', SHA2('AGuzman123', 256), 'EMPLEADO'),
(78, 1078, 'CFernandez', SHA2('CFernandez123', 256), 'EMPLEADO'),
(79, 1079, 'SPalma', SHA2('SPalma123', 256), 'EMPLEADO'),
(80, 1080, 'JSotoJ', SHA2('JSotoJ123', 256), 'EMPLEADO'),
(81, 1081, 'MVega', SHA2('MVega123', 256), 'EMPLEADO'),
(82, 1082, 'DPino', SHA2('DPino123', 256), 'EMPLEADO'),
(83, 1083, 'OLagos', SHA2('OLagos123', 256), 'EMPLEADO'),

-- GERENTES RESTANTES (ADMINS)
(84, 1084, 'LVidal', SHA2('LVidal123', 256), 'ADMIN'),
(85, 1085, 'MSotoM', SHA2('MSotoM123', 256), 'ADMIN'),
(86, 1086, 'EPineda', SHA2('EPineda123', 256), 'ADMIN'),
(87, 1087, 'NElias', SHA2('NElias123', 256), 'ADMIN'),
(88, 1088, 'MASoto', SHA2('MASoto123', 256), 'ADMIN'),
(89, 1089, 'OMendoza', SHA2('OMendoza123', 256), 'ADMIN'),
(90, 1090, 'DCampos', SHA2('DCampos123', 256), 'ADMIN'),

-- EMPLEADOS FINALES
(91, 1091, 'JPonce', SHA2('JPonce123', 256), 'EMPLEADO'),
(92, 1092, 'FTorres', SHA2('FTorres123', 256), 'EMPLEADO'),
(93, 1093, 'KLagos', SHA2('KLagos123', 256), 'EMPLEADO'),
(94, 1094, 'RSotoR', SHA2('RSotoR123', 256), 'EMPLEADO'),
(95, 1095, 'CVidal', SHA2('CVidal123', 256), 'EMPLEADO'),
(96, 1096, 'NDiaz', SHA2('NDiaz123', 256), 'EMPLEADO'),
(97, 1097, 'DRojas', SHA2('DRojas123', 256), 'EMPLEADO'),
(98, 1098, 'APaz', SHA2('APaz123', 256), 'EMPLEADO'),
